                        ...
                        <form action="{{ route('books.update',$book->id) }}" method="POST" enctype="multipart/form-data" class="form form-horizontal" novalidate>
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control sindhi-cursor {{ $errors->has('name_sindhi') ? 'is-invalid' : '' }}" name="name_sindhi" placeholder="نالو" value="{{ $book->name_sindhi }}" maxlength="255" required />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control sindhi-cursor {{ $errors->has('author_sindhi') ? 'is-invalid' : '' }}" name="author_sindhi" placeholder="ليکڪ / مرتب" value="{{ $book->author_sindhi }}" maxlength="255" required />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <textarea class="form-control sindhi-cursor {{ $errors->has('short_description_sindhi') ? 'is-invalid' : '' }}" name="short_description_sindhi" value="{{ $book->short_description_sindhi }}" placeholder="تعارف" >{{ $book->short_description_sindhi }}</textarea>
